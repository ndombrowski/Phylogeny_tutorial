...
The baisc workflows for phylogenetic analyses normally follow these steps:
...
- In these 40 genomes, we searched for sequences that reflect marker genes we commonly use for phylogenetic analyses using a hmmsearch (see below)
